...
- [ ] Step 57: Guide schema + checklist target derivation
  ...
  - **User Instructions**: Run `npx prisma migrate dev --name guide_check`.

- [ ] Step 58: Completeness check runner + API
...
- [ ] Step 61: Template resilience — trustworthy capture + graceful blank fallback
...
- [ ] Step 62: Pick a template everywhere — child pages + empty pages (Confluence-style)
...
- [ ] Step 63: Template resilience + apply-flow test coverage

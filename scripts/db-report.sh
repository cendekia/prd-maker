#!/usr/bin/env bash
# Print a snapshot of workspaces, members and pages from the running
# PRDMaker Postgres container. Useful for a quick "who has what" view
# during the beta without opening a SQL client.
#
# Usage:

  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-fg-1">
      <header className="border-b">
        <div className="mx-auto flex w-full max-w-[760px] items-center justify-between px-6 py-3">
      ...
      <footer className="border-t">
        <div className="mx-auto flex w-full max-w-[760px] items-center justify-between px-6 py-4 text-[11px] text-fg-3">
          <span>
            Made with{" "}
